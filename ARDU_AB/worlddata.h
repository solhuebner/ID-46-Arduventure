...
const unsigned char PROGMEM chunks[] = 
{
  ...
  // space used by chunks: 1188 bytes
  // chunk: 0
...
byte getTileInChunk(const byte &chunk, const Point &tile_pos)
{
  ...
  //return pgm_read_byte(chunks + chunk + tile_pos.x + (tile_pos.y * 6));
}
...
byte getChunk(const Point &chunk_pos)
{
    ...
    switch (chunk_pos.x + chunk_pos.y * 32)
    {
        ...
        case 67: return 8; break; // Solid Bottom
        case 37: return 8; break; // Solid Bottom
        case 132: return 15; break; // pond
        case 102: return 15; break; // pond
        case 39: return 8; break; // Solid Bottom
        case 295: return 16; break; // ladder
        case 229: return 16; break; // ladder
        ...
        case 194: return 17; break; // CliffHouse
        case 227: return 16; break; // ladder
        case 257: return 15; break; // pond
        ...
        case 113: return 32; break; // Brdge
        case 208: return 32; break; // Brdge
    }
